...
export default function SettingsPage() {
  const [primaryFindMethod, setPrimaryFindMethod] = useState(
    localStorage.getItem('primaryFindMethod') || 'image-url'
  );
    ...
    <Layout>
      <FormControl>
        <FormLabel id="demo-radio-buttons-group-label">
          Primary method for finding recipes
        </FormLabel>
        <RadioGroup
