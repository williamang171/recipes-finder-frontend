...
export default function InputViaImage(props: Props) {
    ...
    return (
        <div>
            ...
            {imageSrc === 'url' ? <InputViaImageUrl imageUrl={imageUrl} setImageUrl={setImageUrl} setPredictions={setPredictions} /> : null}
            {imageSrc === 'upload' ? <InputViaImageUpload setImageUrl={setImageUrl} setPredictions={setPredictions} /> : null}
            {imageSrc === 'samples' ? <InputViaImageSamples imageUrl={imageUrl} setImageUrl={setImageUrl} setPredictions={setPredictions} /> : null}
        </div>
    )
}
